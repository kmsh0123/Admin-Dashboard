  ...
  return (
    <div>
      <div>
        <aside
          id="logo-sidebar"
          className=" fixed top-0 left-0 z-40 w-[240px] h-screen transition-transform -translate-x-full sm:translate-x-0"
          aria-label="Sidebar"
        >
          <div className=" bg-white h-full px-3 py-4 overflow-y-auto">
            <a className="flex items-center pl-1 mb-5">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
            ...
            <ul>
              ...
              <div>
                ...
                <li>
                  <a
                    href="#"
                    className="flex items-center justify-between px-[16px] py-3 mt-[7px] text-gray-900 rounded-lg focus:text-white focus:bg-[#4d53e0] dark:hover:bg-gray-700"
                  >
                    <div className=" flex">
                      <span className=" text-[22px]">
                        <TbTypography />
          ...
          <nav className="bg-[#f7f8fb]">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              <div className=" md:hidden ml-10">
                <Group mb={20}>
                  <div className=" ml-[-32px] lg:hidden mt-2" onClick={toggle}>
                    <span className=" text-2xl">
                      <IoMdMenu />
                    </span>
                  </div>
                  <div className=" ml-[140px] items-center flex gap-12">
                        ...
                        <ul>
                          ...
                          <div>
                            <li>
                              <a
                                href="#"
                                className="flex items-center justify-between px-[16px] py-3 text-gray-900 rounded-lg focus:text-white focus:bg-[#4d53e0] dark:hover:bg-gray-700"
                              >
                                <div className=" flex">
                                  <span className=" text-[22px]">
                                    <TbTypography />
              ...
              <div className="relative md:ml-[250px] md:mt-2 lg:mt-1 lg:ml-[212px]">
                <Input
                  variant="unstyled"
              ...
              <div className=" flex gap-[62px]">
                <Menu position="bottom-end" shadow="md" width={340}>
                  <Menu.Target>
                    <div className=" md:mr-[-26px] lg:mr-[-29px] mt-2 lg:mt-1 hidden md:flex flex-wrap gap-[13px] items-center">
                      <span className=" md:text-[20px] lg:text-[24px]">
                        <RiNotification4Line />
                      </span>
                      <span className=" text-[56px] text-[#ff5668] absolute mt-[-47px] md:mt-[-46px] ml-[11px] md:ml-[10px] lg:mt-[-49px] lg:ml-[13px]">
                        .
                      </span>
                    </div>
                  </Menu.Target>
                ...
                <Menu shadow="md" width={200}>
                  <Menu.Target>
                    <div className=" mr-[6px] lg:mr-[-29px] mt-2 lg:mt-1 hidden md:flex flex-wrap gap-[13px] items-center">
                      <Avatar
                        src={
                          "https://flatlogic.github.io/sofia-react-template/static/media/user.13df436f.svg"
                        }
